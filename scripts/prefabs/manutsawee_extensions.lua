...
local common_postinit = function(inst)
    ...
    inst:SetTag("pinetreepioneer", M_CONFIG.CANCRAFTTENT)
    inst:SetTag("slingshot_sharpshooter", M_CONFIG.CANUSESLINGSHOT)
    inst:SetTag("pebblemaker", M_CONFIG.CANUSESLINGSHOT)
