...
StringUtil.merge_table(STRINGS.CHARACTERS.MANUTSAWEE, StringUtil.ImportStringsFile("pl_manutsawee", ENV))
GlassicAPI.MergeTranslationFromPO(MODROOT.."postinit/porkland/languages/pl_", languages[M_CONFIG.locale])
